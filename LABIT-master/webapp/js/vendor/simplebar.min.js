...
!function (t, e) {
    ...
    var r, n, i, o = "object", s = function (t) {
        ...
        c = function (t) {
            ...
            return t
        }, T = Object.defineProperty, R = {
            f: l ? T : function (t, e, r) {
                if (j(t), e = E(e, !0), j(r), k) try {
                    return T(t, e, r)
                } catch (t) {
                }
        ...
        D = "function" == typeof I && /native code/.test(N.call(I)), P = 0, F = Math.random(), V = function (t) {
            return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++P + F).toString(36)
    ...
    var K = {
        ...
        dt = ht.concat("length", "prototype"), pt = {
            ...
            return "Array" == v(t)
        }, Tt = !!Object.getOwnPropertySymbols && !c((function () {
            return !String(Symbol())
        })), Rt = a.Symbol, Wt = C("wks"), zt = function (t) {
            return Wt[t] || (Wt[t] = Tt && Rt[t] || (Tt ? Rt : V)("Symbol." + t))
        }, Ct = zt("species"), Nt = function (t, e) {
            var r;
            return jt(t) && ("function" != typeof (r = t.constructor) || r !== Array && !jt(r.prototype) ? x(r) && null === (r = r[Ct]) && (r = void 0) : r = void 0), new (void 0 === r ? Array : r)(0 === e ? 0 : e)
        ...
        }, Vt = Pt.forEach, Bt = Ft("forEach") ? function (t) {
    ...
    var Qt = Object.keys || function (t) {
        ...
        var r;
        return null !== t ? (te.prototype = j(t), r = new te, te.prototype = null, r[Zt] = t) : r = ee(), void 0 === e ? r : Kt(r, e)
    };
    q[Zt] = !0;
    ...
    var ge = {IteratorPrototype: oe, BUGGY_SAFARI_ITERATORS: ve}, ye = R.f, be = zt("toStringTag"),
        me = function (t, e, r) {
            ...
            return c
        }, Le = K.set, Me = K.getterFor("Array Iterator"), je = ke(Array, "Array", (function (t, e) {
    ...
    var Te = Object.assign, Re = !Te || c((function () {
        var t = {}, e = {}, r = Symbol();
        return t[r] = 7, "abcdefghijklmnopqrst".split("").forEach((function (t) {
            e[t] = t
        })), 7 != Te({}, t)[r] || "abcdefghijklmnopqrst" != Qt(Te({}, e)).join("")
    })) ? function (t, e) {
    ...
    var Pe = "\t\n\v\f\r                　\u2028\u2029\ufeff", Fe = "[" + Pe + "]", Ve = RegExp("^" + Fe + Fe + "*"),
        Be = RegExp(Fe + Fe + "*$"), He = function (t) {
            return function (e) {
                var r = String(b(e));
                return 1 & t && (r = r.replace(Ve, "")), 2 & t && (r = r.replace(Be, "")), r
            }
    ...
    var Ze = function (t, e, r) {
            ...
            var e = R.f, r = V("meta"), n = 0, i = Object.isExtensible || function () {
                return !0
            }, o = function (t) {
            ...
            (t.exports = function (t, r, n, i, o) {
                ...
                if (o) s = t; else {
                    ...
                    if (void 0 !== (h = a) && (le.Array === h || nr[rr] === h)) {
                        for (c = 0, l = st(t.length); l > c; c++) if ((u = i ? d(j(f = t[c])[0], f[1]) : d(t[c])) && u instanceof e) return u;
                        return new e(!1)
                    }
                    s = a.call(t)
                }
    ...
    })), zt("iterator")), _r = zt("toStringTag"), Sr = je.values;
    for (var Ar in Ht) {
        ...
        if (Lr) {
            ...
            if (Lr[_r] || W(Lr, _r, Ar), Ht[Ar]) for (var Mr in je) if (Lr[Mr] !== je[Mr]) try {
                W(Lr, Mr, je[Mr])
            } catch (t) {
                Lr[Mr] = je[Mr]
            }
    ...
    var jr = "Expected a function", Tr = NaN, Rr = "[object Symbol]", Wr = /^\s+|\s+$/g, zr = /^[-+]0x[0-9a-f]+$/i,
        ...
        Fr = Dr || Pr || Function("return this")(), Vr = Object.prototype.toString, Br = Math.max, Hr = Math.min,
        qr = function () {
            return Fr.Date.now()
        };
    ...
    function Yr(t) {
        ...
        t = t.replace(Wr, "");
        var r = Cr.test(t);
        return r || Nr.test(t) ? Ir(t.slice(2), r ? 2 : 8) : zr.test(t) ? Tr : +t
    }
    ...
    var wn = Array.prototype, On = Function.prototype, _n = Object.prototype, Sn = En["__core-js_shared__"],
        ...
        jn = RegExp("^" + kn.call(Ln).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
        Tn = wn.splice, Rn = Fn(En, "Map"), Wn = Fn(Object, "create");
    ...
    function Vn(t, e) {
        ...
        return r.cache = new (Vn.Cache || Nn), r
    }
    ...
    zn.prototype.clear = function () {
        ...
        return !(r < 0) && (r == e.length - 1 ? e.pop() : Tn.call(e, r, 1), !0)
    ...
    var yi = function () {
        ...
        return e.init = function () {
            ...
            var e = !1;
            this.resizeObserver = new di((function () {
                e && t.recalculate()
            ...
            var t = this.heightAutoObserverEl.offsetHeight <= 1, e = this.heightAutoObserverEl.offsetWidth <= 1,
                r = this.contentEl.offsetWidth, n = this.contentWrapperEl.offsetWidth, i = this.elStyles.overflowX,
                o = this.elStyles.overflowY;
            this.contentEl.style.padding = this.elStyles.paddingTop + " " + this.elStyles.paddingRight + " " + this.elStyles.paddingBottom + " " + this.elStyles.paddingLeft, this.wrapperEl.style.margin = "-" + this.elStyles.paddingTop + " -" + this.elStyles.paddingRight + " -" + this.elStyles.paddingBottom + " -" + this.elStyles.paddingLeft;
            var s = this.contentEl.scrollHeight, a = this.contentEl.scrollWidth;
            this.contentWrapperEl.style.height = t ? "auto" : "100%", this.placeholderEl.style.width = e ? r + "px" : "auto", this.placeholderEl.style.height = s + "px";
            var c = this.contentWrapperEl.offsetHeight;
            this.axis.x.isOverflowing = a > r, this.axis.y.isOverflowing = s > c, this.axis.x.isOverflowing = "hidden" !== i && this.axis.x.isOverflowing, this.axis.y.isOverflowing = "hidden" !== o && this.axis.y.isOverflowing, this.axis.x.forceVisible = "x" === this.options.forceVisible || !0 === this.options.forceVisible, this.axis.y.forceVisible = "y" === this.options.forceVisible || !0 === this.options.forceVisible, this.hideNativeScrollbar();
            var l = this.axis.x.isOverflowing ? this.scrollbarWidth : 0,
                u = this.axis.y.isOverflowing ? this.scrollbarWidth : 0;
            this.axis.x.isOverflowing = this.axis.x.isOverflowing && a > n - u, this.axis.y.isOverflowing = this.axis.y.isOverflowing && s > c - l, this.axis.x.scrollbar.size = this.getScrollbarSize("x"), this.axis.y.scrollbar.size = this.getScrollbarSize("y"), this.axis.x.scrollbar.el.style.width = this.axis.x.scrollbar.size + "px", this.axis.y.scrollbar.el.style.height = this.axis.y.scrollbar.size + "px", this.positionScrollbar("x"), this.positionScrollbar("y"), this.toggleTrackVisibility("x"), this.toggleTrackVisibility("y")
            ...
            void 0 === e && (e = "y");
            var r = this.axis[e].scrollbar, n = "y" === e ? t.pageY : t.pageX;
            ...
            var r = this;
            void 0 === e && (e = "y"), this.axis[e].scrollbar.rect = this.axis[e].scrollbar.el.getBoundingClientRect();
            var n = this.axis[e].scrollbar.rect[this.axis[e].offsetAttr],
                i = parseInt(this.elStyles[this.axis[e].sizeAttr], 10),
                o = this.contentWrapperEl[this.axis[e].scrollOffsetAttr],
                s = ("y" === e ? this.mouseY - n : this.mouseX - n) < 0 ? -1 : 1, a = -1 === s ? o - i : o + i;
            !function t() {
                var n, i;
                -1 === s ? o > a && (o -= 40, r.contentWrapperEl.scrollTo(((n = {})[r.axis[e].offsetAttr] = o, n)), window.requestAnimationFrame(t)) : o < a && (o += 40, r.contentWrapperEl.scrollTo(((i = {})[r.axis[e].offsetAttr] = o, i)), window.requestAnimationFrame(t))
            }()
            ...
            try {
                return "none" === getComputedStyle(this.contentWrapperEl, "::-webkit-scrollbar").display || "scrollbarWidth" in document.documentElement.style ? 0 : gi()
            } catch (t) {
                return gi()
            }
    ...
    }, mi = {left: bi(!1), right: bi(!0)}.left;
    At({target: "Array", proto: !0, forced: Ft("reduce")}, {
        reduce: function (t) {
            return mi(this, t, arguments.length, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var xi = R.f, Ei = Function.prototype, wi = Ei.toString, Oi = /^\s*function ([^ (]*)/;
    !l || "name" in Ei || xi(Ei, "name", {
        configurable: !0, get: function () {
            try {
                return wi.call(this).match(Oi)[1]
            } catch (t) {
                return ""
            }
        }
    });
    var _i, Si, Ai = function () {
            var t = j(this), e = "";
            return t.global && (e += "g"), t.ignoreCase && (e += "i"), t.multiline && (e += "m"), t.dotAll && (e += "s"), t.unicode && (e += "u"), t.sticky && (e += "y"), e
        }, ki = RegExp.prototype.exec, Li = String.prototype.replace, Mi = ki,
        ji = (_i = /a/, Si = /b*/g, ki.call(_i, "a"), ki.call(Si, "a"), 0 !== _i.lastIndex || 0 !== Si.lastIndex),
        Ti = void 0 !== /()??/.exec("")[1];
    (ji || Ti) && (Mi = function (t) {
        var e, r, n, i, o = this;
        return Ti && (r = new RegExp("^" + o.source + "$(?!\\s)", Ai.call(o))), ji && (e = o.lastIndex), n = ki.call(o, t), ji && n && (o.lastIndex = o.global ? n.index + n[0].length : e), Ti && n && n.length > 1 && Li.call(n[0], r, (function () {
            for (i = 1; i < arguments.length - 2; i++) void 0 === arguments[i] && (n[i] = void 0)
        })), n
    });
    var Ri = Mi;
    At({target: "RegExp", proto: !0, forced: /./.exec !== Ri}, {exec: Ri});
    var Wi = zt("species"), zi = !c((function () {
        var t = /./;
        ...
        var i = zt(t), o = !c((function () {
            ...
            return r.exec = function () {
                return e = !0, null
            }, "split" === t && (r.constructor = {}, r.constructor[Wi] = function () {
                return r
            }), r[i](""), !e
        }));
        if (!o || !s || "replace" === t && !zi || "split" === t && !Ci) {
            var a = /./[i], l = r(i, ""[t], (function (t, e, r, n, i) {
                return e.exec === Ri ? o && !i ? {done: !0, value: a.call(e, r, n)} : {
                    done: !0,
                    value: t.call(r, e, n)
                } : {done: !1}
            })), u = l[0], f = l[1];
    ...
    }, Ii = Ue.charAt, Di = function (t, e, r) {
        return e + (r ? Ii(t, e).length : 1)
    }, Pi = function (t, e) {
        var r = t.exec;
    ...
    Ni("match", 1, (function (t, e, r) {
        return [function (e) {
            ...
            var i = j(t), o = String(this);
            if (!i.global) return Pi(i, o);
            var s = i.unicode;
            i.lastIndex = 0;
            for (var a, c = [], l = 0; null !== (a = Pi(i, o));) {
                var u = String(a[0]);
                c[l] = u, "" === u && (i.lastIndex = Di(o, st(i.lastIndex), s)), l++
            }
            return 0 === l ? null : c
        }]
    }));
    var Fi = Math.max, Vi = Math.min, Bi = Math.floor, Hi = /\$([$&'`]|\d\d?|<[^>]*>)/g, qi = /\$([$&'`]|\d\d?)/g;
    Ni("replace", 2, (function (t, e, r) {
        return [function (r, n) {
            ...
            var s = j(t), a = String(this), c = "function" == typeof i;
            c || (i = String(i));
            var l = s.global;
            if (l) {
                var u = s.unicode;
            ...
            for (var f = []; ;) {
                ...
                if (null === h) break;
                if (f.push(h), !l) break;
                "" === String(h[0]) && (s.lastIndex = Di(a, st(s.lastIndex), u))
            }
            for (var d, p = "", v = 0, g = 0; g < f.length; g++) {
                h = f[g];
                for (var y = String(h[0]), b = Fi(Vi(it(h.index), a.length), 0), m = [], x = 1; x < h.length; x++) m.push(void 0 === (d = h[x]) ? d : String(d));
                var E = h.groups;
                if (c) {
        ...
        function n(t, r, n, i, o, s) {
            var a = n + t.length, c = i.length, l = qi;
            return void 0 !== o && (o = Mt(o), l = Hi), e.call(s, l, (function (e, s) {
                var l;
                switch (s.charAt(0)) {
                    case"$":
                        return "$";
    ...
    return yi.initDOMLoadedElements = function () {
        document.removeEventListener("DOMContentLoaded", this.initDOMLoadedElements), window.removeEventListener("load", this.initDOMLoadedElements), Array.prototype.forEach.call(document.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'), (function (t) {
            yi.instances.has(t) || new yi(t, $i(t.attributes))
        }))
        ...
        t.forEach((function (t) {
            Array.prototype.forEach.call(t.addedNodes, (function (t) {
                1 === t.nodeType && (t.hasAttribute("data-simplebar") ? !yi.instances.has(t) && new yi(t, $i(t.attributes)) : Array.prototype.forEach.call(t.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'), (function (t) {
                    !yi.instances.has(t) && new yi(t, $i(t.attributes))
                })))
    ...
    }, yi.getOptions = $i, Yt && yi.initHtmlApi(), yi
}));
