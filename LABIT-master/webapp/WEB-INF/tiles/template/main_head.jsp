...
<header class="header">
    ...
    <div class="header-actions">
        ...
        <div class="header-brand">
            ...
            <!-- HEADER BRAND TEXT -->
            <h1 class="header-brand-text">LABIT래빗</h1>
            <!-- /HEADER BRAND TEXT -->
        </div>
        <!-- /HEADER BRAND -->
    </div>
        ...
        <div class="action-list dark">
            ...
            <div class="action-list-item-wrap">
                ...
                <div class="dropdown-box header-dropdown">
                    ...
                    <div class="dropdown-box-header">
                        ...
                        <p class="dropdown-box-header-title">친구요청</p>
                        <!-- /DROPDOWN BOX HEADER TITLE -->

                        <!-- DROPDOWN BOX HEADER ACTIONS -->
                        <div class="dropdown-box-header-actions">
                            <!-- DROPDOWN BOX HEADER ACTION -->
                            <p class="dropdown-box-header-action">친구찾기</p>
                            <!-- /DROPDOWN BOX HEADER ACTION -->

                            <!-- DROPDOWN BOX HEADER ACTION -->
                            <p class="dropdown-box-header-action">설정</p>
                            <!-- /DROPDOWN BOX HEADER ACTION -->
                        </div>
                        <!-- /DROPDOWN BOX HEADER ACTIONS -->
                    </div>
                    ...
                    <div class="dropdown-box-list no-hover" data-simplebar>
                        ...
                        <div class="dropdown-box-list-item">
                            ...
                            <div class="user-status request">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title"><a class="bold" href="profile-timeline.html">운영자</a></p>
                                <!-- /USER STATUS TITLE -->

                                <!-- USER STATUS TEXT -->
                                <p class="user-status-text">6 days ago</p>
                                <!-- /USER STATUS TEXT -->
                    ...
                    <!-- DROPDOWN BOX BUTTON -->
                    <a class="dropdown-box-button secondary" href="hub-profile-requests.html">모든 추가요청 보기</a>
                    <!-- /DROPDOWN BOX BUTTON -->
                </div>
                <!-- /DROPDOWN BOX -->
            </div>
            ...
            <div class="action-list-item-wrap">
                ...
                <div class="dropdown-box header-dropdown">
                    ...
                    <div class="dropdown-box-header">
                        ...
                        <div class="dropdown-box-header-actions">
                            <!-- DROPDOWN BOX HEADER ACTION -->
                            <p class="dropdown-box-header-action">모두읽음</p>
                            <!-- /DROPDOWN BOX HEADER ACTION -->
                    ...
                    <div class="dropdown-box-list medium" data-simplebar>
                        ...
                        <a class="dropdown-box-list-item" href="hub-profile-messages.html">
                            ...
                            <div class="user-status">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title"><span class="bold">운영자</span></p>
                                <!-- /USER STATUS TITLE -->

                                <!-- USER STATUS TEXT -->
                                <p class="user-status-text">무야호 !!...</p>
                                <!-- /USER STATUS TEXT -->

                                <!-- USER STATUS TIMESTAMP -->
                                <p class="user-status-timestamp floaty">1 mins ago</p>
                                <!-- /USER STATUS TIMESTAMP -->
                            </div>
                            <!-- /USER STATUS -->
                        </a>
                    ...
                    <!-- DROPDOWN BOX BUTTON -->
                    <a class="dropdown-box-button primary" href="hub-profile-messages.html">모든 메시지 보기</a>
                    <!-- /DROPDOWN BOX BUTTON -->
                </div>
                <!-- /DROPDOWN BOX -->
            </div>
            ...
            <div class="action-list-item-wrap">
                ...
                <div class="dropdown-box header-dropdown">
                    ...
                    <div class="dropdown-box-header">
                        <!-- DROPDOWN BOX HEADER TITLE -->
                        <p class="dropdown-box-header-title">알림</p>
                        <!-- /DROPDOWN BOX HEADER TITLE -->

                        <!-- DROPDOWN BOX HEADER ACTIONS -->
                        <div class="dropdown-box-header-actions">
                            <!-- DROPDOWN BOX HEADER ACTION -->
                            <p class="dropdown-box-header-action">모두읽기</p>
                            <!-- /DROPDOWN BOX HEADER ACTION -->
                    ...
                    <div class="dropdown-box-list" data-simplebar>
                        ...
                        <div class="dropdown-box-list-item unread">
                            ...
                            <div class="user-status notification">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title"><a class="bold" href="profile-timeline.html">초보자</a> 님이 게시글에 <br> <a class="highlighted" href="profile-timeline.html">댓글을 남겻습니다.</a></p>
                                <!-- /USER STATUS TITLE -->
                        ...
                        <div class="dropdown-box-list-item">
                            ...
                            <div class="user-status notification">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title"><a class="bold" href="profile-timeline.html">LABIT</a> 님이 게시글에 <img class="reaction" src="img/reaction/like.png" alt="reaction-like"> 반응하였습니다. <a class="highlighted" href="profile-timeline.html">(좋아요)</a></p>
                                <!-- /USER STATUS TITLE -->
                    ...
                    <!-- DROPDOWN BOX BUTTON -->
                    <a class="dropdown-box-button secondary" href="hub-profile-notifications.html">모든 알림 보기</a>
                    <!-- /DROPDOWN BOX BUTTON -->
                </div>
                <!-- /DROPDOWN BOX -->
            </div>
